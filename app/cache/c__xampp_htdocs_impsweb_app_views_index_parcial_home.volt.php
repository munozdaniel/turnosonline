        ...
        <ul class="slides-container">
            ...
            <li>
                <a href="#about" class="slow" style="text-decoration: none;">
                    ...
                    <?php echo $this->tag->image(array('img/full-slider/full-slide1.jpg', 'alt' => 'slider imps')); ?>
                    <!-- FIRST SLIDE CAPTION-->
            ...
            <li>
                <a href="#service" class="slow" style="text-decoration: none;">
                    ...
                    <?php echo $this->tag->image(array('img/full-slider/full-slide2.jpg', 'alt' => 'servicios')); ?>
            ...
            <li>
                <a href="#works" class="slow" style="text-decoration: none;">
                    ...
                    <?php echo $this->tag->image(array('img/full-slider/full-slide7.jpg', 'alt' => 'tramites')); ?>
                    <!-- THIRD SLIDE CAPTION-->
                    <div class="slider_caption">
