    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12">
                ...
                <div class="heading">
                    <h2 class="wow fadeInLeftBig">Nuestros Servicios</h2>
                    <p>Desde la comodidad de tu casa podrás usar nuestros servicios online. </p>
                </div>
            </div>
        </div>
        <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            ...
                            <div class="single_service wow fadeInLeft">
                                <?php echo $this->tag->linkTo(array('certificacion/index', '<div class="service_iconarea">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            ...
                            <div class="single_service wow fadeInRight">
                                <?php echo $this->tag->linkTo(array('', 'class' => 'puntero', ' <div class="service_iconarea">
