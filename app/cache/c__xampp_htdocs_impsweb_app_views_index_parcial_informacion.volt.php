                                ...
                                <div class="about_slider">
                                    ...
                                    <div class="featured_slider">
                                        ...
                                        <div class="single_iteam">
                                            <?php echo $this->tag->linkTo(array('index/index#novedades-emprendimiento', 'data-toggle' => 'modal', $this->tag->image(array('img/feature_img1.jpg', 'alt' => 'Emprendimiento Mari Menuco')))); ?>
                                        </div>
                                        <!-- SINGLE SLIDE IN THE SLIDER -->
                                        <div class="single_iteam">
                                            <a href="#novedades-ave" data-toggle="modal">
                                                <?php echo $this->tag->image(array('img/feature_img2.jpg', 'alt' => 'Avistaje Fauna Marina')); ?>
                                            </a>
                                        </div>
                                        <!-- SINGLE SLIDE IN THE SLIDER -->
                                        <div class="single_iteam">
                                            <a href="#novedades-fechaTurnos" data-toggle="modal">
                                                <?php echo $this->tag->image(array('img/feature_img3.jpg', 'alt' => 'Fecha Turnos Online')); ?>
                                            </a>
                                        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <?php echo $this->tag->image(array('img/informacion/opt.jpg', 'class' => 'img-responsive', 'alt' => 'Institucion Optica')); ?>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <?php echo $this->tag->image(array('img/informacion/farm.jpg', 'class' => 'img-responsive', 'alt' => 'institucion farmacia')); ?>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-6 col-md-3">
                            <?php echo $this->tag->linkTo(array('public/img/informacion/03.jpg', 'target' => '_blank', 'class' => 'thumbnail', $this->tag->image(array('img/informacion/03.jpg', 'alt' => 'terreno 1')))); ?>
                        </div>
                        <div class="col-sm-6 col-md-3">
                            <?php echo $this->tag->linkTo(array('public/img/informacion/02.jpg', 'target' => '_blank', 'class' => 'thumbnail', $this->tag->image(array('img/informacion/02.jpg', 'alt' => 'terreno 2')))); ?>
                        </div>
                        <div class="col-sm-6 col-md-3">
                            <?php echo $this->tag->linkTo(array('public/img/informacion/04.jpg', 'target' => '_blank', 'class' => 'thumbnail', $this->tag->image(array('img/informacion/04.jpg', 'alt' => 'terreno 3')))); ?>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <?php echo $this->tag->image(array('img/informacion/avistaje-big.jpg')); ?>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
