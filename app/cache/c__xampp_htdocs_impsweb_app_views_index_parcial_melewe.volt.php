<!--=========== BEGAIN BLOG SECTION ================-->
<section id="blog" style="color: #ffffff !important;">
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12">
                <!-- START BLOG HEADING -->
                <div class="heading">
                    <h2 class="wow fadeInLeftBig" style="color: #ffffff">MELEWE</h2>
                </div>
            </div>
            <div class="col-lg-12 col-md-12">
                <!-- BEGAIN BLOG CONTENT -->
                    ...
                    <div class="blog_slider">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <div class="single_post wow fadeInUp">
                                <div class="blog_img">
                                    <?php echo $this->tag->image(array('img/melewe/villa.jpg', 'alt' => 'villa la angostura')); ?>
                                </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <div class="single_post wow fadeInUp">
                                <div class="blog_img">
                                    <?php echo $this->tag->image(array('img/melewe/caviahue.jpg', 'alt' => 'caviahue')); ?>
                                </div>
                                <h3>Caviahue</h3>
                                <div class="post_commentbox">
                                    <a href=""><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i></a>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <div class="single_post wow fadeInUp">
                                <div class="blog_img">
                                    <?php echo $this->tag->image(array('img/melewe/moquehue.jpg', 'alt' => 'moquehue')); ?>
                                </div>
                                <h3>Moquehue</h3>
                                <div class="post_commentbox">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <div class="single_post wow fadeInUp">
                                <div class="blog_img">
                                    <?php echo $this->tag->image(array('img/melewe/sanmartin.jpg', 'alt' => 'sanmartin')); ?>
                                </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <div class="single_post wow fadeInUp">
                                <div class="blog_img">
                                    <?php echo $this->tag->image(array('img/melewe/lasgrutas.jpg', 'alt' => 'lasgrutas')); ?>
                                </div>
                                <h3>Las Grutas</h3>
                                <div class="post_commentbox">
                                ...
                                <p class="fuente-16">
                                    ...
                                    <br>
                                    <strong>Dirección:</strong> Sierra Paileman y Trapalco<br>
                                    <strong>Tel:</strong> 02934 - 498175<br>
                                    <strong>Las Grutas | RIo Negro</strong><br>
                                </p>
                            </div>
                        </div>
