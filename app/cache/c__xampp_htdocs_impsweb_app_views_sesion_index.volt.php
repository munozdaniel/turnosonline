        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-md-4 col-md-offset-4">
                ...
                <div class="account-wall" style="margin-top: 25%">
                    ...
                    <?php echo $this->tag->form(array('sesion/validar', 'class' => 'form-signin wow flipInX', 'data-wow-duration' => '2s', 'data-wow-delay' => '1s')); ?>
                        <?php echo $this->tag->textField(array('sesion_nombre', 'class' => 'form-control', 'placeholder' => 'Usuario', 'required' => '', 'autofocus' => '')); ?>
                        <?php echo $this->tag->passwordField(array('sesion_contrasena', 'class' => 'form-control', 'placeholder' => 'Contraseña', 'required' => '')); ?>
                        <?php echo $this->tag->submitButton(array('Ingresar', 'class' => 'btn btn-lg btn-primary btn-block')); ?>
                ...
                <div class="modal-body">
                    <div class="row">
                            <div class="col-lg-12 col-md-12 fuente-16">
                                ...
                                <!--  FORM -->
                                <?php echo $this->tag->form(array('sesion/recuperar', 'class' => 'subscribe_form')); ?>
                                    <div class="subscrive_group wow fadeInUp">
                                        <?php echo $this->tag->emailField(array('sesion_email', 'class' => 'form-control subscribe_mail', 'placeholder' => 'INGRESE SU CORREO ELECTRONICO')); ?>
                                        <?php echo $this->tag->submitButton(array('class' => 'subscr_btn btn-theme', 'value' => 'Solicitar')); ?>
                                    </div>
                                <?php echo $this->tag->endForm(); ?>
                            </div>
                    </div>
