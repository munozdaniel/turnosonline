    ...
    public function initialize($entity = null, $options = array())
    {
        ...
        $legajo->addValidators(
            array(
                ...
                new Numericality(
                    array(
                        'message' => 'El <strong>Legajo</strong> debe ser un n�mero sin puntos ni coma.'
                    )
                ),
                new NumberValidator(),
                new StringLength(array(
        ...
        $dni->addValidators(
            array(
                ...
                new Numericality(
                    array(
                        'message' => 'El <strong>DNI</strong> debe ser un n�mero sin puntos ni coma.'
                    )
                ),
                new NumberValidator(),
                new StringLength(array(
        ...
        $telefono->addValidators(
            array(
                ...
                new Numericality( array(
                        'message' => 'El <strong>Telefono</strong> debe ser un n�mero sin puntos ni coma.'
                    )
                ),
                new NumberValidator(),
                new StringLength(array(
