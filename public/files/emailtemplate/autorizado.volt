        ...
        <tr>
            <td align="center" valign="top" id="bodyCell">
                ...
                <table bgcolor="#FFFFFF" border="0" cellpadding="0" cellspacing="0" width="500" id="emailBody">
                                                        ...
                                                        <tr>
                                                            <td align="center" valign="top" class="flexibleContainerBox"
                                                                ...
                                                                <table border="0" cellpadding="30" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        <td align="left" class="textContent">
                                                                            <a href="%linkCancelar%" style="display: inline-block; text-decoration:none;border-bottom: 0px solid;">
                                                                                <img src="http://imps.org.ar/impsweb/public/img/emailtemplate/denegar.png" alt="Denegar" height="42" width="42">
                                                                ...
                                                                <table class="flexibleContainerBoxNext" border="0"
                                                                    ...
                                                                    <tr>
                                                                        <td align="right" class="textContent">
                                                                            <a href="%linkConfirmar%" style="display: inline-block; text-decoration:none;border-bottom: 0 solid !important;">
                                                                                <img src="http://imps.org.ar/impsweb/public/img/emailtemplate/confirmar.png" alt="Confirmar" height="42" width="42" style="text-decoration:none !important;">
                                                                            </a>
                                                                        </td>
                                                                        <td align="left" class="textContent">
                                                                            <a href="%linkConfirmar%" style="display: inline-block; text-decoration:none;border-bottom: 0 solid !important;">
                    ...
                    <!-- MODULE ROW // -->
                    <tr style="border-top: 4px solid #C71818;">
                        <td align="center" valign="top">
                            <!-- CENTERING TABLE // -->
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="right" valign="middle"
                                                                ...
                                                                <table class="flexibleContainerBoxNext" border="0"
                                                                    ...
                                                                    <tr>
                                                                        <td align="left" class="textContent">
                                                                            <h3 style="color:#5F5F5F;line-height:125%;font-family:Helvetica,Arial,sans-serif;font-size:20px;font-weight:bold;margin-top:0;margin-bottom:3px;text-align:left;">
                                                                                IMPORTANTE</h3>

                                                                            <div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;font-weight:bold;">
                                                                                Por favor, lea atentamente las normas de cancelación/confirmación de la asistencia.
                                                                                <hr>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                    ...
                    <!-- MODULE ROW // -->
                    <tr style="    border-bottom: 4px solid #C71818;">
                        <td align="center" valign="top">
                            <!-- CENTERING TABLE // -->
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
