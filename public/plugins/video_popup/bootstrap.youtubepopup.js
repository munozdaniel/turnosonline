...
(function ($) {
        ...
        var modalContent = '<div class="modal-dialog" id="YouTubeModalDialog">' +
                              '<div class="modal-content" id="YouTubeModalContent">' +
                                '<div class="modal-header">' +
                                  ...
                                  '<button type="button" class="close" data-dismiss="modal" style="margin-top: 5px;margin-left: 20px;"><i class="fa fa-close"></i> CERRAR VIDEO</button>' +
            '<a class="btn btn-primary pull-right" href="/impsweb/index/inauguracion"><i class="fa fa-image"></i> VER GALERÍA</a>' +
  ...
  function getYouTubePlayer(URL, width, height) {
    return ['<iframe title="YouTube video player" width="', width, '%" height="', height, '" ',
      'style="margin:0 !important; padding:0; box-sizing:border-box; border:0; -webkit-border-radius:5px; -moz-border-radius:5px; border-radius:5px; margin:', (margin - 1), 'px;" ',
